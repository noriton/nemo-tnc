...
void tnc_buffer_init(void)
{
    ...
    mon_ringbuf[0] = xRingbufferCreate(2048, RINGBUF_TYPE_BYTEBUF);
    mon_ringbuf[1] = xRingbufferCreate(2048, RINGBUF_TYPE_BYTEBUF);
    ...
    if (usb_from_pc[0] == NULL || usb_from_pc[1] == NULL
        ...
        || mon_ringbuf[0] == NULL || mon_ringbuf[1] == NULL) {
