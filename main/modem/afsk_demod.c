...
/* Mark 1200 Hz: w0 = π/4, sin = cos = 0.70711, alpha = 0.14142
 *   b0 = 0.35355 / 1.14142 = 0.30970
 *   a1 = −1.41421 / 1.14142 = −1.23934
 *   a2 = 0.85858 / 1.14142 = 0.75220 */
#define MARK_B0   0.30970f
#define MARK_B2  (-0.30970f)
#define MARK_A1  (-1.23934f)
#define MARK_A2   0.75220f

/* Space 2200 Hz: w0 = 1.43990 rad, sin = 0.99144, cos = 0.13053, alpha = 0.19829
 *   b0 = 0.49572 / 1.19829 = 0.41369
 *   a1 = −0.26106 / 1.19829 = −0.21787
 *   a2 = 0.80171 / 1.19829 = 0.66909 */
#define SPACE_B0   0.41369f
#define SPACE_B2  (-0.41369f)
#define SPACE_A1  (-0.21787f)
#define SPACE_A2   0.66909f

/* エンベロープ LP: α ≈ 0.4 (τ ≈ 2.5 サンプル ≈ 0.26 ms) */
#define ENV_ALPHA  0.4f
